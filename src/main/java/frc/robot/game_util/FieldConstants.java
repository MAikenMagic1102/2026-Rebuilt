 ...
 * All left/right perspectives except for the tower are from the alliance's
 * driver station. The tower is from the field center looking toward the
 * alliance wall.
 */
public class FieldConstants {
        ...
        public static final double startingLineX = Units.inchesToMeters(156.61 + 2); // Measured from the inside of
                                                                                     // starting line
        ...
        public static class Hub {
                public static final Translation3d blueHubCenter = new Translation3d(hubCenterToAllianceWall,
                                fieldWidthMeters / 2, hubHeight);
                ...
                public static final Area blueHubBase = new Area(new Rectangle2D.Double(
                                blueHubCenter2d.getX() - hubWidth / 2, blueHubCenter2d.getY() - hubWidth / 2, hubWidth,
                                hubWidth));
        ...
        public static class Bumps {
                public static final Area bumpBlueLeft = new Area(new Rectangle2D.Double( // uses the bottom left corner
        ...
        public static class ExtendedBumps {
                public static final Area extendedBumpBlueLeft = new Area(new Rectangle2D.Double( // uses the bottom left
                                                                                                 // corner as the
                                                                                                 // starting point
        ...
        public static final double towerToAllianceWall = Units.inchesToMeters(40 + 3.51); // 3.51 is the thickness of
                                                                                          // the tower uprights
        public static final double towerUprightCenterToCenter = Units.inchesToMeters(32.25 + 1.5); // 1.5 is the
                                                                                                   // thickness of the
                                                                                                   // tower uprights

        public static class Tower {
                public static final Translation2d towerBlue = new Translation2d(towerToAllianceWall,
                                fieldWidthMeters / 2 + towerToFieldCenter);
                public static final Translation2d towerRed = rotateAroundCenter(towerBlue);

                public static final Translation2d towerBarBlueLeft = // left when facing the outpost from the center of
                                                                     // the field
                                towerBlue.minus(new Translation2d(0, towerUprightCenterToCenter / 2));
                public static final Translation2d towerBarBlueRight = // right when facing the outpost from the center
                                                                      // of the field
        ...
        public static class Depot {
                public static final Area depotBlue = new Area(new Rectangle2D.Double(
                                0, fieldWidthMeters / 2 + depotToFieldCenter - depotWidth / 2, depotLength,
                                depotWidth));
        ...
        public static class ScoringZones {
                public static final Area scoringZoneBlue = new Area(
                                new Rectangle2D.Double(0, 0, scoringZoneLength, fieldWidthMeters));
        ...
        public static class Trench {
                public static final Area trenchArmRedRight = new Area(
                                new Rectangle2D.Double(trenchToAllianceWall - trenchArmLength / 2, 0, trenchArmLength,
                                                trenchArmWidth));
                ...
                public static final Area trenchBaseRedRight = new Area(new Rectangle2D.Double(
                                trenchToAllianceWall - trenchBaseLength / 2, trenchArmWidth, trenchBaseLength,
                                trenchBaseWidth));
        ...
        /**
         * AdvantageKit-safe loggable version of `AprilTag` that contains data we want
         * without lookups
         */
        ...
        // Trench AprilTags
        public static final AprilTagStruct tagRedTrenchRightInner = new AprilTagStruct(1, field.getTagPose(1).get());
        public static final AprilTagStruct tagRedTrenchRightOuter = new AprilTagStruct(12, field.getTagPose(12).get());
        public static final AprilTagStruct tagRedTrenchLeftInner = new AprilTagStruct(6, field.getTagPose(6).get());
        public static final AprilTagStruct tagRedTrenchLeftOuter = new AprilTagStruct(7, field.getTagPose(7).get());
        public static final AprilTagStruct tagBlueTrenchRightInner = new AprilTagStruct(17, field.getTagPose(17).get());
        public static final AprilTagStruct tagBlueTrenchRightOuter = new AprilTagStruct(28, field.getTagPose(28).get());
        public static final AprilTagStruct tagBlueTrenchLeftInner = new AprilTagStruct(22, field.getTagPose(22).get());
        public static final AprilTagStruct tagBlueTrenchLeftOuter = new AprilTagStruct(23, field.getTagPose(23).get());
        ...
        public static final AprilTagStruct tagRedHubInnerLeft = new AprilTagStruct(4, field.getTagPose(4).get());
        public static final AprilTagStruct tagRedHubInnerRight = new AprilTagStruct(3, field.getTagPose(3).get());
        public static final AprilTagStruct tagRedHubRightInner = new AprilTagStruct(2, field.getTagPose(2).get());
        public static final AprilTagStruct tagRedHubRightOuter = new AprilTagStruct(11, field.getTagPose(11).get());
        public static final AprilTagStruct tagRedHubOuterRight = new AprilTagStruct(10, field.getTagPose(10).get());
        public static final AprilTagStruct tagRedHubOuterLeft = new AprilTagStruct(9, field.getTagPose(9).get());
        public static final AprilTagStruct tagRedHubLeftInner = new AprilTagStruct(5, field.getTagPose(5).get());
        public static final AprilTagStruct tagRedHubLeftOuter = new AprilTagStruct(8, field.getTagPose(8).get());
        public static final AprilTagStruct tagBlueHubInnerLeft = new AprilTagStruct(20, field.getTagPose(20).get());
        public static final AprilTagStruct tagBlueHubInnerRight = new AprilTagStruct(19, field.getTagPose(19).get());
        public static final AprilTagStruct tagBlueHubRightInner = new AprilTagStruct(18, field.getTagPose(18).get());
        public static final AprilTagStruct tagBlueHubRightOuter = new AprilTagStruct(27, field.getTagPose(27).get());
        public static final AprilTagStruct tagBlueHubOuterRight = new AprilTagStruct(26, field.getTagPose(26).get());
        public static final AprilTagStruct tagBlueHubOuterLeft = new AprilTagStruct(25, field.getTagPose(25).get());
        public static final AprilTagStruct tagBlueHubLeftInner = new AprilTagStruct(21, field.getTagPose(21).get());
        public static final AprilTagStruct tagBlueHubLeftOuter = new AprilTagStruct(24, field.getTagPose(24).get());

        // Tower AprilTags
        public static final AprilTagStruct tagRedTowerCentered = new AprilTagStruct(15, field.getTagPose(15).get());
        public static final AprilTagStruct tagRedTowerOffset = new AprilTagStruct(16, field.getTagPose(16).get());
        public static final AprilTagStruct tagBlueTowerCentered = new AprilTagStruct(31, field.getTagPose(31).get());
        public static final AprilTagStruct tagBlueTowerOffset = new AprilTagStruct(32, field.getTagPose(32).get());

        // Outpost AprilTags
        public static final AprilTagStruct tagRedOutpostCentered = new AprilTagStruct(13, field.getTagPose(13).get());
        public static final AprilTagStruct tagRedOutpostOffset = new AprilTagStruct(14, field.getTagPose(14).get());
        public static final AprilTagStruct tagBlueOutpostCentered = new AprilTagStruct(29, field.getTagPose(29).get());
        public static final AprilTagStruct tagBlueOutpostOffset = new AprilTagStruct(30, field.getTagPose(30).get());
        ...
        public static Area rotateAroundCenter(Area area) {
                ...
                Translation2d topRight = new Translation2d(bounds.getX() + bounds.getWidth(),
