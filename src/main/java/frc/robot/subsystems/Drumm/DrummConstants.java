...
public class DrummConstants {
    ...
    // Distance (meters) → Shooter Speed (rotations per second)
public static final InterpolatingDoubleTreeMap kRPSMap = new InterpolatingDoubleTreeMap();
static {
    kRPSMap.put(2.0, 30.0);
    kRPSMap.put(3.0, 40.0);
    kRPSMap.put(4.0, 50.0);
    kRPSMap.put(5.0, 55.0);
    kRPSMap.put(6.0, 60.0);
}
