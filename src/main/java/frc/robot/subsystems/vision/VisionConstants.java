...
//       new Transform3d(0.0, 0.0, 0.0, new Rotation3d(0.0, 0.0, -Math.PI));
  ...
  public static Transform3d robotToCameraLeft =
      new Transform3d(inchesToMeters(-2.213), inchesToMeters(-1.596), inchesToMeters(17.453), 
      new Rotation3d(0.0,Units.degreesToRadians(-20), Units.degreesToRadians(180 + 60)));
  public static Transform3d robotToCameraCenter =
      new Transform3d(inchesToMeters(0), inchesToMeters(-2.57), inchesToMeters(17.875),
