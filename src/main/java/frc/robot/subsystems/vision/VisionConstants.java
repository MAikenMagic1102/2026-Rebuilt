...
public class VisionConstants {
  ...
  public static String cameraLeftWide = "cameraLeftWide";
  public static String cameraCenterNarrow = "cameraCenterNarrow";
  public static String cameraRightWide = "cameraRightWide";
  ...
  // TODO: CONVERT MEASURES (XYZ) TO ROBOT CENTER TO CAMERA CENTER (Rotations are a-ok)
  ...
  public static Transform3d robotToCameraCenter =
      new Transform3d(inchesToMeters(-1.5), inchesToMeters(1.5), inchesToMeters(16), 
      new Rotation3d(0.0, Units.degreesToRadians(35), Units.degreesToRadians(90)));
